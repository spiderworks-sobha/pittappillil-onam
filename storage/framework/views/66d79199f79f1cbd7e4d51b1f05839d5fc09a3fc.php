...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="update-success" style="display:none;" class="alert alert-success alert-dismissible fade show">
                <strong>Success!</strong> <?php echo e($data->name); ?> Application Updated successfully.
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>

            <div class="col-lg-12">
                <div class="card no-border aster-card">
                    <div class="card-header"><?php echo e($data->name); ?></div>
                    <div class="card-body">
                        ...
                        <form accept-charset="utf-8" id="application_update" class="row">
                            ...
                            <div class="mb-2 col-lg-8 col-md-8 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12 select">
                                    <select id="status" name="status" class="form-select">
                                        ...
                                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($data->status == $item): ?> selected="selected" <?php endif; ?> class="stat-color-<?php echo e($item); ?>" value="<?php echo e($item); ?>"><?php echo e($option); ?></option>
                            ...
                            <div class="mb-2 col-lg-4 col-md-4 col-sm-12 col-12">
                                ...
                                <select id="otp-verify" name="otp_state">
                                    <option value="verified" <?php if($data->otp_state == "verified"): ?> selected="selected" <?php endif; ?>>Verified</option>
                                    <!--                                               <option  value="pending" <?php if($data->otp_state == "pending"): ?> selected="selected" <?php endif; ?>>Pending</option>
 -->
                                </select>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" id="working_place" name="working_place" class="form-control"><?php echo $data->working_place; ?></textarea>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" id="g_c_or_a" name="g_c_or_a" class="form-control"><?php echo $data->g_c_or_a; ?></textarea>
                            ...
                            <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" id="notes" name="notes" class="form-control"><?php echo $data->notes; ?></textarea>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12" id="state_select">
                                ...
                                <div class="col-sm-12">
                                    <select class="js-states-basic-single form-control" name="state" id="state">
                                        ...
                                        <option value="<?php echo e($state->name); ?>" <?php if($state->name == $data->state): ?>
                                            selected="selected" <?php endif; ?>><?php echo e($state->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12" id="city_select">
                                ...
                                <div class="col-sm-12">
                                    <select class="js-city-basic-single form-control" name="district_or_city" id="ajax_city">
                                        ...
                                        <option value="<?php echo e($city->city); ?>" <?php if($city->city == $data->district_or_city): ?>
                                            selected="selected" <?php endif; ?>><?php echo e($city->city); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-4">
                                        <select name="salutation" id="salutation" placeholder="Salutation" class="form-control">
                                            <option value="Mr." <?php if($data->salutation == "Mr."): ?> selected = selected <?php else: ?> edit <?php endif; ?>>Mr.</option>
                                            <option value="Ms." <?php if($data->salutation == "Ms."): ?> selected = selected <?php else: ?> edit <?php endif; ?>>Ms.</option>
                                            <option value="Mrs." <?php if($data->salutation == "Mrs."): ?> selected = selected <?php else: ?> edit <?php endif; ?>>Mrs.</option>
                                            <option value="Dr." <?php if($data->salutation == "Dr."): ?> selected = selected <?php else: ?> edit <?php endif; ?>>Dr.</option>

                                        </select>
                                        <!-- <input type="text" name="salutation" id="salutation" placeholder="Salutation" class="form-control" value="<?php echo e($data->salutation); ?>" edit readonly> -->

                                        <!-- <small class="form-text">Example help text that remains unchanged.</small> -->
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-8">
                                        <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="<?php echo e($data->name); ?>" edit readonly>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="phone" name="phone" placeholder="Phone " class="form-control" value="<?php echo e($data->phone); ?>" edit readonly>
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                    <!-- <small class="form-text">Example help text that remains unchanged.</small> -->
                                </div>
                            </div>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="whatsapp_no" name="whatsapp_no" placeholder="WhatsApp Number " class="form-control" value="<?php echo e($data->whatsapp_no); ?>" edit readonly>
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                    <!-- <small class="form-text">Example help text that remains unchanged.</small> -->
                                </div>
                            </div>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="email" name="email" placeholder="Email Address" class="form-control" value="<?php echo e($data->email); ?>" edit readonly>
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                    <!-- <small class="form-text">Example help text that remains unchanged.</small> -->
                                </div>
                            </div>
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="locality" name="locality" placeholder="Locality" class="form-control" value="<?php echo e($data->locality); ?> " edit readonly>

                                    <!--<textarea type="locality" name="locality" placeholder="Locality" id="locality" class="form-control " edit readonly><?php echo $data->locality; ?></textarea>-->
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="pincode" name="pincode" placeholder="Pincode" class="form-control" value="<?php echo e($data->pincode); ?>" edit readonly>
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="card_number" name="card_number" placeholder="Card Number" class="form-control " value="<?php echo e($data->card_number); ?>" readonly>
                                    <!--                                                <small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <!--                                                 <input type="text" id="card_name" name="card_name" placeholder="Card Name" class="form-control " value="<?php echo e($data->card_name); ?>"  >
 ...
 -->
                                    ...
                                    <select name="card_name" id="" class="form-control">
                                        ...
                                        <option value="<?php echo e($item->discount_card_offer_name); ?>" <?php if($item->discount_card_offer_name == $data->card_name): ?> selected = selected <?php endif; ?>><?php echo e($item->discount_card_offer_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <select name="discount_initiated_by" id="discount_initiated_by" placeholder="Discount Initiated By" class="form-control">
                                    ...
                                    <option class="stat-color-<?php echo e($item); ?>" value="<?php echo e($item); ?>" <?php if($data->discount_initiated_by == $item): ?> selected="selected" <?php endif; ?>><?php echo e($option); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="discount_recommended_by" name="discount_recommended_by" placeholder="Discount Recommended By" class="form-control " value="<?php echo e($data->discount_recommended_by); ?>">
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="uh_id" name="uh_id" placeholder="UHID" class="form-control " edit value="<?php echo e($data->uh_id); ?>" readonly>
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="ip_no" name="ip_no" placeholder="IP No" class="form-control " edit value="<?php echo e($data->ip_no); ?>" readonly>
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            ...
                            <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="vaid_date" name="vaid_date" placeholder="Valid Date" class="form-control " edit value="<?php echo e($data->vaid_date); ?>" readonly>
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
                            ...
                            <div class="mb-2 row" align="center">
                                <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="view-card-block">
                                        <?php if($data->card_path != null && $data->rand_img_key != null): ?> <label><a href="<?php echo e(url('dl/'.$data->rand_img_key)); ?>" target="_blank"><span class="btn btn-outline-secondary">View Card</span></a></label><?php endif; ?>

                                        <?php if($data->rand_img_key != null): ?> <div class="copy">
                                            <input type="text" value="<?php echo e(url('dl/'.$data->rand_img_key)); ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function save_data(data) {
            $.ajax({
                type: 'POST',
                url: "<?php echo e(url('admin/discount/update')); ?>",
                data: data,
                dataType: "json",
...
</script><?php /**PATH /home/asterprivilege/public_html/resources/views/admin/discounts/edit.blade.php ENDPATH**/ ?>