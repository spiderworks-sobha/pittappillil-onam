<nav id="sidebar" class="">
    ...
    <ul class="list-unstyled components text-secondary">
        ...
        <li>
            <a href="<?php echo e(route('admin.applications')); ?>"><i class="fas fa-table"></i> Applications</a>
        </li>
          <li style="display:block;">
            <a href="<?php echo e(route('admin.discounts')); ?>"><i class="fas fa-table"></i>Discounts</a>
        </li>
        <li>
            <a href="<?php echo e(route('admin.settings')); ?>"><i class="fas fa-cog"></i> Settings</a>
        </li>
...
</nav><?php /**PATH /home/asterprivilege/public_html/resources/views/admin/nav.blade.php ENDPATH**/ ?>