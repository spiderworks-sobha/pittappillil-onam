                        ...
                        <form accept-charset="utf-8" id="application_update" class="row">
                            ...
                            <div class="mb-2 col-lg-4 col-md-4 col-sm-12 col-12">
                                ...
                                <select id="otp-verify" name="otp_state">
                                    <option edit value="verified" <?php if($data->otp_state == "verified"): ?> selected="selected" <?php endif; ?>>Verified</option>
                                    <option edit value="pending" <?php if($data->otp_state == "pending"): ?> selected="selected" <?php endif; ?>>Pending</option>
                                </select>
                            ...
                            <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <!--<div class="col-sm-12">-->
                                <!--    <input type="text" id="dob" name="dob" placeholder=" Date of Birth" class="form-control " edit value="<?php echo e($data->dob); ?>" readonly>-->
                                <!--    <small class="form-text edit-msg">I'm readonly</small>-->
                                <!--</div>-->
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function save_data(data) {
            $.ajax({
                type: 'POST',
                url: "<?php echo e(url('admin/application/update')); ?>",
                data: data,
                dataType: "json",
...
<script>
    $(document).ready(function() {
        ...
        $("#state").on('change', function() {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(url('admin/application/city-filter/')); ?>",
                data: {
                    state: state
                },
                success: function(resp) {
...
</script><?php /**PATH /home/asterprivilege/public_html/resources/views/admin/application/edit.blade.php ENDPATH**/ ?>