...
<?php $component->withAttributes([]); ?>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="<?php echo e(route($route.'.create')); ?>" class="btn btn-sm btn-light show-form-modal">Add New Gift</a>
                    </div>
                </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <?php echo $__env->make('admin.gifts._partials.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        var my_columns = [
            ...
            {data: 'is_special_gift', name: 'is_special_gift'},
        ...
        var validate = function(){
            $('#InputFrm').validate({
                ...
                messages:
                {
                    name: "Please enter gift name",
                    probability: {
                        required: "Please enter gift probability"
                    },
                },
...
<?php endif; ?>
<?php /**PATH D:\Xampp\htdocs\pittappillil-onam\resources\views/admin/gifts/index.blade.php ENDPATH**/ ?>