...
div#discounts_paginate {
    margin-top: 30px;
}
div#discounts_length {
    margin-bottom: 20px;
}
            body.modal-open {
                overflow: hidden;
...
.card-type {
                ...
                <div class="row">
                        ...
                        <div class="card-type">
                          ...
                          <!--   <select name="card_type" id="card_type" class="form-control">
                            ...
                            <a data-toggle="modal"  id="create" data-target="#discountsEdit"><button class="btn btn-outline-secondary">Create New</button></a>

                            <button title="Export To Excel" id="ex-btn" class="" style="font-size: 13px;" id="ad-edit"><a id="export" href="<?php echo e(url('admin/discount/export/')); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <?php echo $__env->make('admin.discounts.view.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <!-- basic modal -->
                    <div class="modal fade" id="discountsEdit" tabindex="-1" role="dialog" aria-labelledby="discountsEdit" aria-hidden="true">
         ...
         <script>
            $(document).ready(function() {
                ...
                function popup_edit_data(edit_id) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo e(url('admin/discount/edit')); ?>/"+id,
          ...
          <script>
            $(document).ready(function() {
                ...
                function popup_create_data() {

                    $.ajax({
                        type: 'GET',
                        url: "<?php echo e(url('admin/discount/create')); ?>/",
                        success: function(data) {
         ...
         $(document).ready(function(){
                             $(document).on('click', '#send', function(event) {
                                      ...
                                      if (result.isConfirmed) {
                                         $.ajax({
                                                    type: 'POST',
                                                    url: "<?php echo e(url('send/discount')); ?>",
                                                    data: {
                                                             _token:function() {
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#discounts').DataTable({
                    ajax: {
                        url: "<?php echo e(url('admin/discounts')); ?>"
                    },
                    serverSide: true,
                    processing: true,
                    aaSorting: [
 ...
 $("#discountsEdit").on("hidden.bs.modal", function () {
                                  table.ajax.reload();
});
...
<?php endif; ?>
<?php /**PATH /home/asterprivilege/public_html/resources/views/admin/discounts/index.blade.php ENDPATH**/ ?>