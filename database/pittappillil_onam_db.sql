...
--
-- Host: localhost:3306
-- Generation Time: Aug 09, 2022 at 08:47 AM
...
CREATE TABLE `applications` (
  ...
  `name` text,
  `phone` text,
  `whatsapp_no` varchar(250) DEFAULT NULL,
  `email` text,
  `locality` text,
  `pincode` int(11) DEFAULT NULL,
  `card_path` text,
  `card_number` varchar(250) DEFAULT NULL,
  `card_type_id` varchar(250) DEFAULT NULL,
  `vaid_date` text,
  `dob` date DEFAULT NULL,
  `otp` text,
  `otp_state` text,
  `status` int(11) NOT NULL DEFAULT '0',
  `whatsapp_api_status` text,
  `rand_img_key` text,
  `notes` text,
  `working_place` text,
  ...
  `discount_initiated_by` varchar(250) DEFAULT NULL,
  `uh_id` varchar(250) DEFAULT NULL,
  `ip_no` text,
  `g_c_or_a` text,
  `trace_id` text,
...
INSERT INTO `card_types` (`id`, `type_name`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Swasthyam', 1, '2022-07-29 05:13:46', NULL),
(2, 'Platinam', 1, '2022-07-29 05:18:10', NULL),
(3, 'Discount', 0, '2022-07-29 06:03:13', NULL);
...
--
-- Table structure for table `discount_card_names`
--

CREATE TABLE `discount_card_names` (
  `id` int(11) NOT NULL,
  `discount_card_offer_name` text NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `discount_card_names`
--

INSERT INTO `discount_card_names` (`id`, `discount_card_offer_name`, `created_at`, `updated_at`) VALUES
(1, '25% off on doctor\'s consultation', '2022-08-01 06:15:46', NULL),
(2, '20% off on lab tests & radiology', '2022-08-01 06:15:46', NULL),
(3, '20% off on Aster Wellness', '2022-08-01 06:16:11', NULL),
(4, '10% off on IP services', '2022-08-01 06:16:11', NULL);
...
--
-- Indexes for table `discount_card_names`
--
ALTER TABLE `discount_card_names`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `discount_card_names`
--
ALTER TABLE `discount_card_names`
