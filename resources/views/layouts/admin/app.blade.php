...
<head>
    ...
    <link href="{{asset('assets/admin')}}/vendor/jquery-confirm/jquery-confirm.min.css" rel="stylesheet">
...
<body class="font-sans antialiased">
    ...
    <script src="{{asset('assets/admin')}}/vendor/jquery-confirm/jquery-confirm.min.js"></script>
