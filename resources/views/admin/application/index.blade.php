...
.card-type .form-control {
            ...
            <div class="content">
                ...
                <div class="row">
                        ...
                        <div class="card-type">
                            ...
                            <button title="Export To Excel" id="ex-btn" class="" style="font-size: 13px;" id="ad-edit"><a id="export" href="{{url('admin/application/export/')}}">
         ...
         <script>
            $(document).ready(function() {
                ...
                function popup_edit_data(edit_id) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{url('admin/application/edit')}}/"+id,
 ...
 $("#applicationEdit").on("hidden.bs.modal", function () {
  ...
  var ex = "{{url('admin/application/export/')}}";
