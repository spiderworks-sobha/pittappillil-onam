                ...
                <div class="row">
                        ...
                        <div class="card-type">
                          ...
                          <!--   <select name="card_type" id="card_type" class="form-control">
                                @if(isset($card_types)&& count($card_types)>0)
                                @foreach($card_types as $card_type)
                                <option value="{{$card_type->id}}" class="form-control">{{$card_type->type_name}}</option>
                                @endforeach
                                @endif
                            </select> -->
                            <a data-toggle="modal"  id="create" data-target="#discountsEdit"><button class="btn btn-outline-secondary">Create New</button></a>

                            <button title="Export To Excel" id="ex-btn" class="" style="font-size: 13px;" id="ad-edit"><a id="export" href="{{url('admin/discount/export/')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                @include('admin.discounts.view.table')
         ...
         <script>
            $(document).ready(function() {
                ...
                function popup_edit_data(edit_id) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{url('admin/discount/edit')}}/"+id,
