                        ...
                        <form accept-charset="utf-8" id="application_update" class="row">
                            ...
                            <div class="mb-2 col-lg-4 col-md-4 col-sm-12 col-12">
                                ...
                                <select id="otp-verify" name="otp_state">
                                    <option value="verified" @if($data->otp_state == "verified") selected="selected" @endif>Verified</option>
                                    <!--                                               <option  value="pending" @if($data->otp_state == "pending") selected="selected" @endif>Pending</option>
 -->
                                </select>
                            ...
                            <div class="mb-2 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <!--                                                 <input type="text" id="card_name" name="card_name" placeholder="Card Name" class="form-control " value="{{$data->card_name}}"  >

 -->
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                    <select name="card_name" id="" class="form-control">
                                        @if($dis_card_names && count($dis_card_names)>0)
                                        @foreach($dis_card_names as $item)
                                        <option value="{{$item->discount_card_offer_name}}" @if($item->discount_card_offer_name == $data->card_name) selected = selected @endif>{{$item->discount_card_offer_name}}</option>
                                        @endforeach
                                        @endif
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <select name="discount_initiated_by" id="discount_initiated_by" placeholder="Discount Initiated By" class="form-control">
                                    ...
                                    @foreach($discount_initiated_by as $option => $item)
                                    <option class="stat-color-{{$item}}" value="{{$item}}" @if($data->discount_initiated_by == $item) selected="selected" @endif>{{$option}}</option>
                                    @endforeach
                            ...
                            <div class="mb-2 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="discount_recommended_by" name="discount_recommended_by" placeholder="Discount Recommended By" class="form-control " value="{{$data->discount_recommended_by}}">
                                    <!--<small class="form-text edit-msg">I'm readonly</small>-->
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#state").on('change', function() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{url('admin/discount/city-filter/')}}",
                data: {
                    state: state
                },
                success: function(resp) {
